# Author: Matt Stanley
# Date: 12/19/2019
# This code generates a Flask Webpage that allows the user to upload a photo of their math equation and pass it through out trained CNN model.
# The webpage then will display the CNN's predicted equation in latex code. 
